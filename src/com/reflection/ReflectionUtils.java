...
/*
    ...
    2.getType:以Class形式返回类型（属性对应类的class对象）(形参列表)
    3.getName:返回属性名
    ...
    3.getParameterTypes: 以Class[]返回参数类型数组(构造器形参类型)
 */
public class ReflectionUtils {
    ...
    public void api_01() throws ClassNotFoundException, NoSuchMethodException {
        ...
        //getMethods: 获取所有public修饰的方法，包含本类以及父类的也包括Object
        ...
        System.out.println(personCls.getPackage());//package com.reflection
