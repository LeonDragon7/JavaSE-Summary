...
public class Interest {
    ...
    而且也解决了多种接入设备连入互联网的障碍。

    IPV4 表示：4个字节（32位）表示 1个字节的范围是0~255
    IPV6 表示：16个字节（128位）是IPV4的四倍
    ...
    网络通信协议
    协议(tcp/ip)
    TCP/IP (Transmission Control Protocol/Internet Protocol) 的简写,中文译名为传输控制协议/因特网互联协议,又叫网络通讯协议,这个协议是Internet最基本的协议、
