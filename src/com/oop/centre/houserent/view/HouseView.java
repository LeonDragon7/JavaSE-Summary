package com.oop.centre.houserent.view;
/*
    界面层
...
import com.oop.centre.houserent.service.HouseService;
import com.oop.centre.houserent.utils.Utility;
...
public class HouseView {
    ...
    public void listHouses(){
        ...
        for (int i = 0; i < list.length; i++) {
            if(list[i] == null){//如果为null,就不用再显示了
                break;
            }
